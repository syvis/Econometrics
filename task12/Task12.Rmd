...
(b) dalyje RMSE galimai didesnis dėl to, kad prognozuojame daugiau reikšmių su mažesniu training set'u. (a) dalyje RMSE mažesnis, nes training set'as didesnis (apie 80 proc. duomenų), taip pat prognozuojame mažiau reikšmių, todėl tikimybė suklysti darant prognozę yra mažesnė.
