...
Iš grafiko matome, kad liekanos nėra išsidėsčiusios ties nuliu, yra nemažų reikšmių, dėl nelabai tikslios prognozės. Egzistuoja galimas stacionarumas.

```{r,echo=FALSE}
hist(f4$res, breaks="FD", main = "Liekanų sklaidos histograma")
```
